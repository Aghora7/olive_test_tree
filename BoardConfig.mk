...
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/configs/android.hardware.atrace@1.0-service.xml
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/configs/android.hardware.cas@1.1-service.xml
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/configs/android.hardware.gnss@2.0-service-qti.xml
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/configs/manifest_android.hardware.drm@1.2-service.widevine.xml
